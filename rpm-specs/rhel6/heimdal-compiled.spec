...
%changelog
* Wed Jul 24 2013 bmaupin <bmaupin@users.noreply.github.com> 1.5.2-2
- build with latest version of OpenSSL (1.0.1e)

* Thu Oct 18 2012 bmaupin <bmaupin@users.noreply.github.com> 1.5.2-1
...
* Mon Apr  4 2011 bmaupin <bmaupin@users.noreply.github.com> 1.4-1
- explicitly set rpath to point to SSL libraries
- upgrade to version 1.4
- apply patch for missing lib/otp/version-script.map

* Mon May 17 2010 bmaupin <bmaupin@users.noreply.github.com> 1.3.2-1
