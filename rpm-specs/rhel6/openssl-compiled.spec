...
%changelog
* Wed Jul 24 2013 bmaupin <bmaupin@users.noreply.github.com> 1.0.1e-1
- upgrade to version 1.0.1e

* Thu Oct 18 2012 bmaupin <bmaupin@users.noreply.github.com> 1.0.1c-1
- upgrade to version 1.0.1c
- include dist in the release variable
- update spec file according to RHEL 6 guidelines

* Wed Mar 30 2011 bmaupin <bmaupin@users.noreply.github.com> 1.0.0d-1
- upgrade to version 1.0.0d

* Thu May 13 2010 bmaupin <bmaupin@users.noreply.github.com> 1.0.0-2
- exclude tsget tool (requires WWW::Curl::Easy Perl module, not provided in RHEL repositories)
- compile using optimizations (-O2)

* Tue May 11 2010 bmaupin <bmaupin@users.noreply.github.com> 1.0.0-1
