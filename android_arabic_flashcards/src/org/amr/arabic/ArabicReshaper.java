...
public class ArabicReshaper{
	...
	public static char[][] ARABIC_GLPHIES=
		/*
		 * all numbers are decimal equivalents of hex, for example:
		 * 0621, FE80, FE8B, FE8C, FE80 (first line, 1569)
		 * 0628, FE8F, FE91, FE92, FE90 (1576)
		 *  
		 * first number is letter by itself,
		 * second is isolated,
		 * third is initial,
		 * fourth is middle,
		 * fifth is final
		 * 
		 * where no final (letter doesn't connect on right) and/or
		 * middle (word doesn't connect on left), author simply reuses
		 * the isolated form.  is this the best way?  seems kind of 
		 * like a hack to me...
		 * 
		 * okay, if only 3 forms, author reuses isolated for final.
		 * if 2 forms, author reuses isolated for initial and middle 
		 * for final
		 */
